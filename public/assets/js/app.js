    ...
    0: function (e, t, n) {
        ...
        e.exports = function () {
            ...
            function T(e, t, r, i, a) {
                s(t, "x-for");
                let o = w("function" == typeof r ? e.evaluateReturnExpression(t, r) : r), l = function (e, t, n, r) {
                    let i = f(t, e, "if")[0];
                                    ...
                                    for (var S = m.pattern || m, O = l.next, A = u; O !== n.tail && !(c && A >= c.reach); A += O.value.length, O = O.next) {
                                        ...
                                        if (!(x instanceof i)) {
                                            ...
                                            if (v && O != n.tail.prev) {
                                                ...
                                                var w = I.index + (g && I[1] ? I[1].length : 0),
                                                    _ = I.index + I[0].length, P = A;
                                                for (P += O.value.length; w >= P;) O = O.next, P += O.value.length;
                                                if (P -= O.value.length, A = P, O.value instanceof i) continue;
                                                for (var N = O; N !== n.tail && (P < _ || "string" == typeof N.value); N = N.next) T++, P += N.value.length;
                                            ...
                                            if (I) {
                                                ...
                                                w = I.index + b;
                                                var k = I[0].slice(b), R = (_ = w + k.length, x.slice(0, w)),
                                                    L = x.slice(_), C = A + x.length;
