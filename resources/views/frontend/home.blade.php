    ...
    <section class="py-12 md:py-20 lg:py-32">
        <div class="max-w-screen-xl mt-12 mx-auto px-8 md:pr-0 md:mt-16 lg:mt-24 xl:pr-8">
            ...
            <div class="mt-3 sm:mt-12 md:flex">
                <div class="sm:grid sm:grid-cols-2 sm:gap-x-4 sm:gap-y-8 md:w-1/2 lg:w-3/4 lg:grid-cols-4">
                    <div>
                        <div class="mt-3">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" style="width: 13px"
                                         data-icon="suitcase-rolling" class="svg-inline--fa fa-suitcase-rolling fa-w-12 mr-1 text-gray-600"
                ...
                <div class="mt-10 max-w-md md:mt-0 md:w-1/2 lg:w-1/4">
                    <p class="text-xs text-gray-600 sm:text-sm">Laravel is a web application framework with expressive,
                        elegant syntax. We believe development must be an enjoyable and creative experience to be truly
                        fulfilling. Laravel attempts to take the pain out of development by easing common tasks used in
                        most web projects.</p>
